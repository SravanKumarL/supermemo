...
if (ANTHROPIC_API_KEY) {
  console.log('API Key Format:', ANTHROPIC_API_KEY.startsWith('sk-ant-') ? 'Valid' : 'Invalid');
}
...
if (!ANTHROPIC_API_KEY) {
  ...
  console.warn('Warning: ANTHROPIC_API_KEY has invalid format. It should start with "sk-ant-"');
} 